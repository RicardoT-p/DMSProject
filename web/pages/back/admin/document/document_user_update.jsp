...
<%
    ...
    String basePath = request.getScheme() + "://"
            ...
            + path +"/";
    String updateUrl = basePath +"pages/back/admin/document/DocumentBackServlet/update";
%>
<html>
<head>
    <base href="<%=basePath%>">
...
<section id="container">
    ...
    <section id="main-content">
        <section class="wrapper">
            <form action="<%=updateUrl%>" method="post" id="insertForm" class="form-horizontal" enctype="multipart/form-data">
                <fieldset>
                    <legend>
                        <label>增加部门文档</label>
                    </legend>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div name="document.title" id="document.title">${Document.title}</div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1">
                    ...
                    <div class="form-group">
                       <div class="col-md-3 col-md-offset-3">
                           <input type="hidden" name="document.filename" value="${Document.filename}">
                           <input type="hidden" name="document.dcid" value="${Document.dcid}">
