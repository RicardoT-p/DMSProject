...
<%
    ...
    String insertUrl = basePath +"pages/back/admin/action/ActionBackServlet/insert";
%>
<html>
<head>
    <base href="<%=basePath%>">
            ...
            <form action="<%=insertUrl%>" method="post" id="insertForm" class="form-horizontal">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="action.icon" id="action.icon" placeholder="请输入图标名称！"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-1">
                        ...
                        <div class="col-md-8">
                            <input class="form-control" name="action.url" id="action.url" placeholder="请输入权限描述信息！"/>
                        </div>
                    </div>
                    <div class="form-group">
